...
casa = ["I Marry You F 💍","Of course I do love you,F💍❤️","I don't want to i love Fabian💍💔","Of course I don't Lol💍💔","I'm sorry,but I love FABIANA💍"]

curativo = ["life",": 100%🔴","🔴You Used the Bandage Your Life is at: 50%🔴","🔴You Used the Bandage Your Life is at: 60%🔴","🔴You Used Your Life Bandage is at: 75% Your Life is at: 90%🔴","🔴You Used the Bandage It is at: 91%🔴"]
...
class Bot(BaseBot):
    async def on_start(self, session_metadata: SessionMetadata) -> None:
        print("working")
        await self.highrise.walk_to(Position(18.5 , 0.0 , 18.0 , "FrontRight"))
    async def on_user_join(self, user: User, position: Position | AnchorPosition) -> None:
        ...
        await self.highrise.send_whisper(user.id,f"Aveces hablo español, pero amo a Fabiana.")
    ...
    async def on_chat(self, user: User, message: str) -> None:
        ...
        if message.lower().startswith("!tipall ") and user.username in ["ShoKytoo","tu_cost2","AnaMbr","zen707Jum","Moi_1231"]:
              parts = message.split(" ")
              if len(parts) != 2:
        ...
        if message.lower().startswith("!tipme ") and user.username in ["ShoKytoo","tu_cost2","AnaMbr","zen707Jum","Moi_1231"]:
                try:
        ...
        if        message.startswith("/tele") or              message.startswith("/tp") or              message.startswith("/fly") or     message.startswith("!tele") or      message.startswith("!tp") or     message.startswith("!fly"):
          if user.username in ["ShoKytoo","tu_cost2","AnaMbr","zen707Jum","Moi_1231"]:            await self.teleporter(message)
        ...
        if              message.startswith("Fairyfloat All") or                              message.startswith("/emote all fairyfloat") or       message.startswith("!emote all fairyfloat"):
          if user.username in ["ShoKytoo","tu_cost2","AnaMbr","zen707Jum","Moi_1231"]:
        ...
        if message == "!fit 1" and user.username in ["ShoKytoo","tu_cost2","AnaMbr","zen707Jum","Moi_1231"]:
        ...
        if message == "!fit 2" and user.username in ["ShoKytoo","tu_cost2","AnaMbr","zen707Jum","Moi_1231"]:
        ...
        if message == "!fit 3"  and user.username in ["ShoKytoo","tu_cost2","AnaMbr","zen707Jum","Moi_1231"]:
...
Item(type='clothing', amount=1, id='earrings-n_room12019goldhoops', account_bound=False, active_palette=-1),
        ...
        if message == "!fit 4" and user.username in ["ShoKytoo","tu_cost2","AnaMbr","zen707Jum","Moi_1231"]:
        ...
        if message == "!fit 5" and user.username in ["ShoKytoo","tu_cost2","AnaMbr","zen707Jum","Moi_1231"]:
        ...
        if message == "!fit 6" and user.username in ["ShoKytoo","tu_cost2","AnaMbr","zen707Jum","Moi_1231"]:
        ...
        if message == "!fit 7" and user.username in ["ShoKytoo","tu_cost2","AnaMbr","zen707Jum","Moi_1231"]:
        ...
        if message == "!fit 8" and user.username in ["ShoKytoo","tu_cost2","AnaMbr","zen707Jum","Moi_1231"]:
...
Item(type='clothing', amount=1, id='earrings-n_room12019goldhoops', account_bound=False, active_palette=-1),
        ...
        if message == "!fit 9" and user.username in ["ShoKytoo","tu_cost2","AnaMbr","zen707Jum","Moi_1231"]:
        ...
        if message == "!fit 10" and user.username in ["ShoKytoo","tu_cost2","AnaMbr","zen707Jum","Moi_1231"]:
...
Item(type='clothing', amount=1, id='earrings-n_room12019goldhoops', account_bound=False, active_palette=-1),
        ...
        if message == "!fit 11" and user.username in ["ShoKytoo","tu_cost2","AnaMbr","zen707Jum","Moi_1231"]:
